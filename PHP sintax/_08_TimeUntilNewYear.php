...
echo "Hours until new year : ".number_format($leftHours,0,""," "). "\n";
echo "Minutes until new year : ".number_format($leftMinutes,0,""," ")."\n";
echo "Seconds until new year :".number_format($leftSeconds,0,""," ")."\n";
